package team.kaleni.pingtowerbackend.controller;
...
import team.kaleni.pingtowerbackend.service.UserService;
...
public class UserController {
    ...
    @Operation(
            ...
            description = """
                    Принимаем в себя json с логином, паролем и email-ом.
    ...
    @Operation(
            summary = "Отбирает всех пользователей, у которых логин начинается на {prefix} без учёта регистра."
    )
    ...
    @Operation(
            summary = "Ищет пользователя по email-у"
    )
